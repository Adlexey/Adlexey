...
| Курс | Статус |
|------|--------|
| JavaScript Basics | ✅ Завершен |
| React Fundamentals | ✅ Завершен |
| Node.js Advanced | 🟡 В процессе |
| TypeScript Mastery | ⏳ Планируется |
| AWS Cloud Practitioner | ✅ Завершен |
| Docker & Kubernetes | 🟡 В процессе |
